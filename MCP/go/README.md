# Custom Search Client MCP Server

This MCP (Model Content Protocol) server provides access to Custom Search Client API functionality through HTTP, HTTPS, and STDIO transport modes.
